...
Intenta llegar al escritorio desde el directorio raiz usado el comando `cd().` *Nota:* Desde tu carpeta usuario (la que se abre por defecto cuando inicias PROLOG) verás que hay una carpeta llamada `Desktop` o `Escritorio` mediante la cual puedes llegar. 
